...
export async function POST(request: Request) {
  ...
  // Default hashes: Admin=0408, User=1234 (bcryptjs cost 10)
  const adminHash =
    process.env.ADMIN_PIN_HASH ||
    '$2b$10$mZtr3om7Vj0j23AlcU1IQeH2YlntKx6/vJtH4eD8wIW0GQTjZyuDy';
  const userHash =
    process.env.USER_PIN_HASH ||
    '$2b$10$6qQBfepprnuAjqwWcV4zG.xgIK/40ZdryXot36AvEOwV0jVkFrVIe';
