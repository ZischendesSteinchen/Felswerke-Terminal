...
- Widget-Registry mit 14 registrierten Widget-Typen in vier Kategorien:
  - Market: Crypto Watchlist, Stock Watchlist, Price Chart, Market Quote, Market Overview,
    Top Movers, Portfolio Tracker
...
- Keine Datenbank noetig — zwei PIN-Hashes in Environment-Variablen reichen
...
- Version ist zentral in `src/lib/version.ts` (`APP_VERSION = 'v2.0'`)
...
- User-Logout-Button (aktuell nur im Admin-Panel verfuegbar)
