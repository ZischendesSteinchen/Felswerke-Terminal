...
### Core
- **Widget-based Workspace System** — Drag-and-drop grid with multiple workspaces, 14 widget types
...
> Without PIN hashes set, the app auto-authenticates as admin (dev convenience).
...
Backend (Next.js API Routes)
  ...
  └── /api/history, /api/market, /api/fear-greed, /api/stocks, /api/alerts, /api/top-movers
...
| Category | Widgets |
|----------|---------|
| Market | Crypto Watchlist, Stock Watchlist, Price Chart, Market Quote, Market Overview, Top Movers, Portfolio Tracker |
